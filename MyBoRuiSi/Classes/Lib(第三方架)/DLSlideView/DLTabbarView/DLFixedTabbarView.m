...
//    }
 ...
 /** 添加底部灰色装饰条*/
    ...
    UILabel *graylabel = [[UILabel alloc]initWithFrame:CGRectMake(0, 47, kScreenWidth, 0.5) ];
...
#pragma mark - **************** 调整滑块位置
    ...
    trackView_.frame = CGRectMake(trackX, self.bounds.size.height - kTrackViewHeight+2, width, kTrackViewHeight);
}
