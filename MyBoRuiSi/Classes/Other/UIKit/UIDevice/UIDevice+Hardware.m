...
- (NSString*)hardwareDescription {
    ...
    WLLog(@"This is a device which is not listed in this category. Please visit https://github.com/inderkumarrathore/UIDevice-Hardware and add a comment there.");
    WLLog(@"Your device hardware string is: %@", hardware);
...
- (CGSize)backCameraStillImageResolutionInPixels
{
    switch ([self hardware]) {
        ...
        case IPAD_MINI_WIFI_CDMA:
            ...
            break;
        default:
            WLLog(@"We have no resolution for your device's camera listed in this category. Please, make photo with back camera of your device, get its resolution in pixels (via Preview Cmd+I for example) and add a comment to this repository on GitHub.com in format Device = Hpx x Wpx.");
            WLLog(@"Your device is: %@", [self hardwareDescription]);
            break;
    }
    return CGSizeZero;
}
