...
-(id)initWithNewWindow{
    ...
    if (self) {
        ...
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, self.bottom, self.width, 220.0f) style:UITableViewStylePlain];
...
-(void)showChooseActionSheetBlock:(chooseActionSheetCallBackBlock )bolck cancelButtonTitle:(NSString *)cancel array:(NSArray *)array{
    ...
    CGFloat tableHeight = (CELLHIEGHT *(array1.count + 1))+5;
    
    UIView *tapView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, WLScreenW, WLScreenH-_tableView.height)];
    ...
    [UIView animateWithDuration:0.25 delay:0.0 options:UIViewAnimationOptionCurveEaseIn animations:^{
        ...
        [_tableView setTop:(WLScreenH-_tableView.height)];
        [_tableView setFrame:CGRectMake(0, WLScreenH-tableHeight, self.width, tableHeight)];
